...
<body >
   <div class="page-wrapper body1 p-t-130 ">
        <div class="wrapper wrapper--w680">      
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title"><center>Payment Form</center></h2>
                    <form action="paymentreceipt.jsp" method="POST">
                        ...
                        <div class="input-group">
                          ...
                          <div class="input-group">
                            <label class="label">Select Payment Mode</label>
                            <div class="rs-select2 js-select-simple select--no-search">
                         ...
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="totalfee" name="totalfee" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Pending Fee</label>
                                    <input class="input--style-4" type="text" name="pendingfee" maxlength="10"  required>
                                </div>
                            </div>
                        </div>
                        <div class="p-t-15">
                          <center>  <button class="btn btn--radius-2 btn--blue" type="submit">Payment</button> </form>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <button class="btn btn--radius-2 btn--blue" type="submit"><a href="admission.jsp" style="color:white; text-decoration: none;">Cancel</a></button></center>
                       </div>
